...
def make_log_dirs(
    ...
    param_name = "improve_step"
    log_dirs = os.path.join(ROOT_DIR, task_name, f"{param_name}={args[param_name]}", "select_num=%d"%args["select_num"], "threshold=%.2f"%args["threshold"], exp_name)
